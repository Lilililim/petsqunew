    ...
    <div class="container-fluid">
      <div class="collapse navbar-collapse d-flex align-items-center justify-content-between" id="navbarNav">
        ...
        <ul class="nav nav-pills">
          ...
          <a class="nav-link ms-2 me-2 active" href="productpageAdmin.php">Product</a>
      ...
      <div class="card border-0 shadow rounded-0 h-100">
        <div class="card-body p-3 p-sm-5 h-100">
          <div class="row mb-4">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary editbtn" href="#" role="edit_btn">Edit</a>
                      </td>
                      <td>
            ...
            <a class="btn btn-primary" href="tambahproduct.php" role="button">Tambah Produk</a>
          </div>
        </div>
      </div>
      <!-- </div> -->
        ...
        <form action="koneksi.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="EditNama" id="EditNama" class="form-control" placeholder="Masukan Nama Produk">
            </div>

            <div class="form-group">
              <label> Deskripsi Produk </label>
              <input type="text" name="EditDeskripsi" id="EditDeskripsi" class="form-control" placeholder="Masukan Deskripsi Baru">
            </div>

            <div class="form-group">
              <label> Harga </label>
              <input type="text" name="EditHarga" id="EditHarga" class="form-control" placeholder="Masukan Harga Baru">
            </div>
          </div>
  ...
  <script>
    $(document).ready(function() {
      $('.editbtn').on('click', function() {
        ...
        $('#EditNama').val(data[1]);
        $('#EditDeskripsi').val(data[2]);
        $('#EditHarga').val(data[3]);
      });
    });
  </script>
