        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse d-flex align-items-center justify-content-between" id="navbarNav">
                ...
                <ul class="nav nav-pills">
                    ...
                    <a class="nav-link ms-2 me-2 active" href="daftarpelangganpage.php">Daftar User</a>
            ...
            <div class="card border-0 shadow rounded-0 h-100">
                <div class="card-body p-4 p-sm-5 h-100">
                    ...
                    <form method="post" action="koneksi.php">
                        ...
                        <h6>Nama Produk</h6>
                        <div class="form mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Nama Produk" name="Nama_produk">
                        </div>
                        <h6>Deskripsi</h6>
                        <div class="form mb-3">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Deskripsi" name="Deskripsi_produk">
                        </div>
                        <h6>Harga</h6>
                        <div class="form mb-3">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Harga" name="Harga_produk">
                        </div>
                        <div class="d-grid">
                            <button class="btn btn-primary btn-add text-uppercase fw-bold" type="submit" name="tambah_btn">Tambah</button>
                        </div>
                    </form>
                </div>
            </div>
